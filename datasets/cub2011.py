...
class CUB200(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False):
        super(CUB200, self).__init__(root, transform=transform, target_transform=target_transform)
...
if __name__ == '__main__':
    train_dataset = CUB200('./cub2011', train=True, download=False)
    test_dataset = CUB200('./cub2011', train=False, download=False)
